                    ...
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <div class="pull-right">
                                    <!--- login button -->	
                                  <?php // $user_query=mysql_query("select * from students where studid='". $_SESSION['Admin_Logon']."'")or die(mysql_error());
									//while($row=mysql_fetch_array($user_query)){
									//$id=$row['studid'];  ?>
   
                                    
                                     <img  src="admin/images/logo.jpg"  class="img img-rounded" id="picture">
                                        &nbsp;
                                    <div class="btn-group">
                                       
                                        <button class="btn btn-success"><i class="icon-user icon-large"></i>&nbsp;Logout <?php //echo $row['studid'] . " " . $row['course']; ?></button>
