...
<html>
<head>
		<title><?php echo isset($title) ? $title . ' | Faud Detection| Admin panel' :  'Faud Detection| Admin panel' ; ?></title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<!-- Bootstrap -->
            <link rel="icon" type="image/png" href="../img/logo.png" />
			<link href="admin/css/font-awesome.min.css" rel="stylesheet" media="screen">
