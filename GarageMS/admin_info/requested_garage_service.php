						...
						<center class="title">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								ORDER BY tbl_service.service_id")or die(mysql_error());
                                    ...
                                    <td width="170">
                                    <a href="approve.php?servicedetails_id=<?php echo $row['servicedetails_id']; ?>" 
                                      class="btn1 btn1-status" style="text-decoration:none;">Accept</a>&nbsp;&nbsp;
                                      <a rel="tooltip" id="<?php echo $servicedetails_id; ?>" href="#delete_book<?php echo $servicedetails_id; ?>" data-toggle="modal"    class="btn btn-success">Clear service&nbsp;<i class="icon-check icon-large"></i></a>
