                                ...
                                <div class="pull-right">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="registration.php" role="button"><i class="icon-user-md icon-large"></i>&nbsp;	Register</a></li>
											 <li><a href="admin_info/login.php" role="button"><i class="icon-user-md icon-large"></i>&nbsp;Admin</a></li>
